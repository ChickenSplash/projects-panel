/* ChartDB SQLite metadata export (standard SQLite dialect).
   Run this against the app database and paste the single returned
   value into the ChartDB "Smart Query" import box. */
WITH fk_info AS (
  SELECT
      json_group_array(
          json_object(
